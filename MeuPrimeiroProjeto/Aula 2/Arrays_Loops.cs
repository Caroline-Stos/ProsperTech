...
namespace MeuPrimeiroProjeto.Aula2
{
    internal class clsArrays_Loops
    {
        ...
        static int[] arrayWhile = new int[] { 1, 2, 3, 4 };
        ...
        internal static void TesteForEach()
        {
            foreach (var item in arrDiasSemana)
            {
                if (item == "Sabado")
                {
                    Console.WriteLine("Sábado é dia de dar banho no cachorro.");
                }
        ...
        internal static void PercorrerDoWhile()
        {
            int indice = 0;
            do
            {
        ...
        internal static void PercorrerWhile()
        {
            int indice = 0;
            while (arrayWhile[indice] < 5)
            {
